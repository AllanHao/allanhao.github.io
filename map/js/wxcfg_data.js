var wxdata = {
    ...
    wx_myuser: ["wx46fad80e6a7e3e07", "d6ab46a5028e1facd5980c2544bcf040"],
    ...
    get_access_token: function () {
        ...
        fetch(wxdata.url, { mode: 'no-cors' }).then(function (response) {
    ...
    get_jsapi_ticket: function () {
        ...
        fetch("https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token=" + wxdata.access_token + "&type=jsapi", { mode: 'no-cors' }).then(function (response) {
            return response.text();
        }).then(function (msg) {
            if (msg.errcode == 0) {
                wxdata.jsapi_ticket = msg.ticket;  // 需要缓存，存活时间ticket_expires_in  默认为7200s  
...
wxdata.url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=" + wxdata.wx_myuser[0] + "&secret=" + wxdata.wx_myuser[1];

//wxdata.get_access_token();  // 1  
wxdata.access_token = "9_oD9_FSwmbh3mq9vv3_8E1NDjhgJ-RgJsvmxqRxxZRzl3jj52ew_iXiduTu2wFRD6UA_IzgKAvVEa7lm5xb7wSMMH0Uj2XSrNQj3E8OUn8s1yO_LupFHjy0O4sJ8_fO-xmxNlgzobhK_G9G_UPOVaADAXWD";  //2  

// wxdata.get_jsapi_ticket();  //3  
wxdata.jsapi_ticket = "kgt8ON7yVITDhtdwci0qeV7Z2xucVXgRslX43irOqlaeVBWmdvSU4ZTe_V1TSkRgTwsCec-9qg17t3mKc_MElg"  //4  
